...
import aboutBG from './images/about-bg.jpg';  // Import the image
            ...
            >
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                    ...
                    <button
                        ...
                        className="text-black text-3xl font-extrabold relative -top-0.5 leading-none"
                    >
                        &times;
                    </button>
                </div>
                ...
                <div className="relative z-10 flex items-center w-full">
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ color: 'white' }}
                        >
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" style={{ filter: 'brightness(150%)' }}>
                                <path
